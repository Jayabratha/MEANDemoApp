app.controller('photosController', [ '$scope', 'fileReaderService', 'photoUploadService', 'getPhotosService', 'removePhotoService', '$cookies',
	 function($scope, fileReaderService, photoUploadService, getPhotosService, removePhotoService, $cookies){
